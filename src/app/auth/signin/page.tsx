...
const SignInPage = () => {
  return (
    <div className="flex justify-center items-center min-h-[calc(100vh-10rem)]">
      <div className="grid grid-rows-3 gap-4 max-h-fit w-auto bg-white p-8 rounded-2xl">
        ...
        <div className="flex py-4">
          <button
            onClick={login}
            className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-black bg-gray-200 rounded-lg hover:bg-black hover:text-white transition-colors duration-200 cursor-pointer"
          >
            <svg
              className="w-6 h-6"
              fill="currentColor"
        ...
        <div className="flex min-w-full justify-center pt-8">
