...
const jobDetails = async ({ params }: { params: Promise<{ id: string }> }) => {
  ...
  return (
    <div className="bg-white max-w-7xl mx-auto h-fit rounded-lg ">
      <div className="p-6 grid grid-rows-1 gap-y-8 w-full">
          ...
          <div className="flex flex-col">
            ...
            <div className="md:flex justify-between pt-4">
              ...
              <div className="md:space-y-2 space-y-1 mt-1 md:w-1/2 font-sans">
                <p className="md:font-semibold text-cyan-600 md:text-lg">
        ...
        <p className="text-cyan-700 md:font-semibold">
