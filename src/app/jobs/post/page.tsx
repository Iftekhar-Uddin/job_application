...
const PostYourJob = (e:any) => {
  ...
  {if(session){
    ...
    <div className="flex justify-center items-center min-h-[calc(100vh-10rem)]">
      <div className="min-w-xxs w-lg mx-auto md:p-4 bg-white rounded-md md:rounded-xl">
        <h1 className="md:text-2xl font-bold text-cyan-700 ml-2 mt-2">Create a job post</h1>
        <div className="md:h-[calc(100vh-14rem)] overflow-y-auto p-4">
          ...
          <form className="space-y-1.5 md:space-y-4" onSubmit={handleSubmit}>
            ...
            <div className="flex justify-end">
              <button
                type="submit"
                className="text-white outline-0 bg-cyan-700 text-sm md:text-md px-2 py-1 md:px-3 md:py-2 cursor-pointer rounded-full hover:bg-cyan-800 disabled:cursor-not-allowed mt-4"
              >
                Create your post
              </button>
            </div>
