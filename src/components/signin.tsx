...
const Signin = () => {
    ...
    return (
        <div className="grid grid-rows-1 gap-4 max-h-fit w-96 bg-white rounded-xl">
            <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-2">
                ...
                <button type="submit" className="rounded-md w-full mt-4 py-2.5 bg-black text-white cursor-pointer">Sign In</button>
                {error && <p className="text-red-500 text-sm mx-auto justify-center">{error}</p>}

            </form>
            <div className="flex min-w-full justify-center">
                <p className="w-full text-sm text-end text-gray-600">
